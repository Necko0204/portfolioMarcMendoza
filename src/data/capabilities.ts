...
export const capabilityGroups: CapabilityGroup[] = [
  ...
  },
  {
    ...
    description: "Real-world experience with messages, deadlines, follow-ups, meetings, and client-facing coordination.",
    items: [
      ...
      { name: "Client communication", proof: "Executive VA experience", href: "/about" }
    ]
  }
];
