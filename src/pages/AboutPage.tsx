  ...
  return (
    <>
      <Seo
        ...
        description="Marc Mendoza's professional story across Information Technology, executive VA work, freelance full-stack delivery, and client operations."
        path="/about"
      />
      <header className="page-hero about-hero">
        <div className="content-shell about-hero-layout">
          <div>
            ...
            <p>
              Information Technology created the technical foundation. Executive assistance added operational discipline, and freelance full-stack delivery made that foundation practical through live client systems.
            </p>
          </div>
