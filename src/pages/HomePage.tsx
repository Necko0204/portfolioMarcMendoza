      ...
      <section className="section story-section">
        <div className="content-shell story-layout">
          ...
          <Reveal delay={0.08} className="story-copy">
            <p>
              Information Technology built the technical foundation. Executive VA work added operational discipline, and freelance full-stack work turned that foundation into live client systems. Appointment-setting and community-management work added further understanding of messages, deadlines, approvals, and client expectations.
            </p>
            <p>
